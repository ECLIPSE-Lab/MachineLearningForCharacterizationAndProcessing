...
\emph{(These first three weeks ensure students understand why ML behaves
differently on materials data compared to CIFs and DFT databases in the
other course.)}
...
\emph{(This unit ensures profoundly processing-centered ML
content---distinct from genomics's structure-first world.)}
...
\emph{(This module draws synergy with your research---students love
learning real lab-relevant problems.)}
